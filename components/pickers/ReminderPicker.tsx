...
export function ReminderPicker({ value, onChange }: Props) {
  ...
  const selectedLabel =
    ...
    (value.startsWith("custom:")
      ? `Custom (${Number(value.split(":")[1])} day${Number(value.split(":")[1]) === 1 ? "" : "s"} before)`
      : "Automatic (7 days before)");
  ...
  return (
    <View style={CommonStyles.pickerContainer}>
      ...
      <PickerModal
        ...
        addButtonLabel="+ Add Custom Reminder"
        ...
        customPlaceholder="Enter days before expiry"
      />
    </View>
  );
}
